...
func_var do_action(func_var code_act, func_var *multi_res)
{
    ...
    switch (code_act)
    {
        case 1:
            ...
            printf("Filling a matrix from a file\n");
        ...
        case 2:
            printf("Filling the matrix manually\n");
        ...
        case 4:
            printf("The filling of the vector manually\n");
        ...
        case 5:
            printf("Product of a classical matrix by a vector\n");
        ...
        case 6:
            printf(" Product of a matrix of a special storage method by a vector\n");
        ...
        case 7:
            printf("The output of the comparison time works\n");
        ...
        case 8:
            printf("Output multiplication results\n");
